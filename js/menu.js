        ...
        .then(data => {
            ...
            if (data.data && data.data.length > 0) {
                ...
                data.data.forEach(item => {
                    ...
                    // Check if category image exists, if not use a placeholder
                    const categoryImageUrl = item.category.image ? item.category.image : 'path/to/placeholder-image.jpg'; // Replace with your placeholder image path
